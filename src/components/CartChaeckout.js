...
function CartChaeckout() {
  ...
  return (
    <div className="h-auto py-28 bg-gray-100 pt-20">
      <h1 className="mb-10 text-center text-3xl font-bold text-[#b91c1c]">Cart Items</h1>
      <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
            ...
            <div key={cartItem.id} className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                <div className="mt-5 sm:mt-0">
                  <h2 className="text-xl font-bold text-black">{cartItem.title}</h2>
                ...
                <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                  ...
                  <div className="flex items-center justify-between space-x-4">
                    <p className="text-sm">${calculateTotalPrice(cartItem.id, cartItem.price)}</p>
                    <svg
        ...
        <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
          ...
          <div className="flex justify-between">
            ...
            <div className="">
              <p className="mb-1 text-lg font-bold">${(parseFloat(calculateSubtotal()) + 4.99).toFixed(2)}</p>
              <p className="text-sm text-gray-700">including VAT</p>
            </div>
          </div>
          <button className="mt-6 w-full rounded-md bg-[#b91c1c] py-1.5 font-medium text-blue-50 ">Check out</button>
        </div>
      </div>
    </div>
  );
